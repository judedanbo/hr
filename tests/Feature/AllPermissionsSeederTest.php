...
class AllPermissionsSeederTest extends TestCase
{
    ...
    public function test_seeder_creates_all_permissions(): void
    {
        ...
        // Verify the expected number of permissions were created
    ...
    public function test_seeder_creates_qualification_permissions_with_correct_spelling(): void
    {
        ...
        $this->assertFalse(
            Permission::where('name', 'veiw all staff qualifications')->exists(),
            "Typo 'veiw all staff qualifications' should NOT exist"
        );
    }

    public function test_seeder_creates_contact_permissions(): void
    {
        $this->seed(AllPermissionsSeeder::class);
    ...
    public function test_seeder_creates_document_permissions(): void
    {
        $this->seed(AllPermissionsSeeder::class);
