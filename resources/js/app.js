...
createInertiaApp({
  ...
  setup({ el, app, props, plugin }) {
          ...
          config: {
            classes: generateClasses({
              ...
              "family:box": {
                ...
                label: "$reset text-sm text-gray-700 dark:text-gray-50 mt-1 select-none",
                wrapper: "flex items-center mb-1",
              },
              "family:button": {
                input:
                  "$reset inline-flex items-center bg-green-600 dark:bg-gray-900 text-white text-sm font-normal py-3 px-6 rounded focus-visible:outline-2 focus-visible:outline-green-600 dark:focus-visible:outline-gray-800 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin",
                wrapper: "mb-1",
              ...
              select: {
                ...
                option:
                  "formkit-multiple:p-3 formkit-multiple:text-sm text-gray-700 dark:text-gray-50",
              },
              textarea: {
                inner:
    ...
    `,
                timeInput:
                  "w-full border-2 border-gray-300 rounded-md p-2 my-[2em] focus-visible:outline-green-500 dark:focus-visible:outline-gray-900 ",
