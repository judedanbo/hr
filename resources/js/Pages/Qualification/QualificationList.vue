...
const formatDistance = (date) => {
    return formatDistanceStrict(
        new Date(date),
        new Date(props.qualifications[0].now),
        { addSuffix: true }
    );
};
...
const indeterminate = computed(
    () =>
        ...
        selectedStaff.value.length < props.qualifications.length
);
</script>
<template>
                        ...
                        >
                            ...
                            >
                                <tr
                                    ...
                                    :key="qualification.staff_number"
                                    :class="[
                                ...
                                >
                                    <td class="relative px-7 sm:w-12 sm:px-6">
                                        ...
                                        <input
                                            ...
                                            :value="qualification.staff_number"
                                            type="checkbox"
