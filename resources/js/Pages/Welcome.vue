...
<template>
    ...
    >
        <div
            class="lg:flex flex-wrap w-full md:max-w- sm:px-6 lg:px-0 max-w-6xl"
        >
            <img
            ...
            >
                <h1 class="text-white lg:text-green-900 text-2xl mb-6">
                    Audit Service, Ghana
                </h1>
                <h1
                    class="text-white lg:text-green-900 text-4xl hidden md:block"
                >
            ...
            <div class="text-right pr-8 mt-3 lg:w-full">
