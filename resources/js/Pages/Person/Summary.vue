    ...
    <div class="md:rounded-lg bg-gray-50 dark:bg-gray-500 shadow-sm ring-1 ring-gray-900/5 dark:ring-gray-300/80">
      <dl class="flex flex-wrap">
        <div class="flex-auto pl-6 pt-6">
          ...
          <dd class="mt-1 text-base font-semibold leading-6 text-gray-900 dark:text-gray-100">
            {{ person.name }}
          </dd>
        </div>
        ...
        <div class="mt-4 flex w-full flex-none gap-x-4 px-6">
          <dt class="flex-none">
            ...
            <UserPlusIcon class="h-6 w-5 text-gray-400 dark:text-gray-50" aria-hidden="true" />
          </dt>
          <dd class="text-sm leading-6 text-gray-500 dark:text-gray-50">
