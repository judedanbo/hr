...
let deleteDependent = () => {
    Inertia.delete(
        route("dependent.delete", { dependent: props.dependent.id })
    );
    emit("closeModal");
};
</script>
                    ...
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel
                            ...
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                    ...
                                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-900">Delete
                                            Address of
                                            <!-- {{ dependent.staff }} -->
                                        </DialogTitle>
                                        <div class="mt-2">
                            ...
                            <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                <button @click.prevent="deleteDependent" type="button"
                                ...
                                <button type="button"
                                    ...
                                    @click="$emit('closeModal')" ref="cancelButtonRef">
                                    Cancel
                                </button>
                            </div>
                        </DialogPanel>
