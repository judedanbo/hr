                ...
                <transition enter-active-class="transition ease-out duration-100"
                    ...
                    <MenuItems
                        ...
                        <Link :href="route('unit.show', { unit: unit.id })"
                            class="block px-3 py-1 text-sm leading-6 text-gray-900 dark:text-gray-50">View<span
                            class="sr-only">, {{
                                unit.name }}</span></Link>
                        </MenuItem>
                        <MenuItem>
                        <p @click.prevent="edit(unit.id)"
                            class="block px-3 py-1 text-sm leading-6 text-gray-900 dark:text-gray-50 cursor-pointer">
