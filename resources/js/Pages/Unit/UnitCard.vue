...
<template>
	<li
		class="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-500"
	>
		<div
			class="flex items-center gap-x-4 border-b border-gray-900/5 bg-green-50 dark:bg-gray-500 p-6"
		>
			<div
			...
			<Menu as="div" class="relative ml-auto">
				<MenuButton
					class="-m-2.5 block p-2.5 text-gray-500 hover:text-gray-500"
				>
					<span class="sr-only">Open options</span>
					<EllipsisHorizontalIcon
						class="h-5 w-5 dark:text-gray-50"
						aria-hidden="true"
					/>
				</MenuButton>
				<transition
		...
		<dl
			class="-my-3 divide-y divide-gray-100 dark:divide-gray-500 px-6 py-4 text-sm leading-6"
		>
