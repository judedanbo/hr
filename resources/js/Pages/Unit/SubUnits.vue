          ...
          >
            <div class="flex min-w-0 gap-x-4">
              <div class="min-w-0 flex-auto">
                <p class="text-sm font-semibold leading-6 text-gray-900 dark:text-gray-50">
                  <a :href="subUnit.href" class="hover:underline">{{
                    subUnit.name
                  }}</a>
                </p>
                <p class="mt-1 flex text-xs leading-5 text-gray-500 dark:text-gray-300">
                  <a
                    :href="`mailto:${subUnit.email}`"
                    class="truncate hover:underline"
                    >Staff {{ subUnit.staff_count }} </a
                  >
                </p>
              </div>
            </div>
            <div class="flex shrink-0 items-center gap-x-6">
              <div class="hidden sm:flex sm:flex-col sm:items-end">
                <p class="text-sm leading-6 text-gray-900 dark:text-gray-50">{{ subUnit.rank }}</p>
                <p
