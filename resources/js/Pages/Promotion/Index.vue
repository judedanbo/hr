...
<!-- Todo Add breakpoints -->
        <div>
            ...
            <div class="mt-6 overflow-hidden border-t border-gray-100 dark:border-gray-800 w-3/4 mx-auto">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-700">
                                ...
                                <template v-for="(promotion, index) in  promotions.data " :key="index">
                                    ...
                                    <tr v-if="promotion.year != $field" class="text-sm leading-6 text-gray-900 bg-gray-50 dark:bg-gray-800
                                        ...
                                        <th scope="col" class="relative isolate py-2 font-semibold">
                                            ...
                                            <Link :href="route('promotion.show', {year: promotion.year})">{{ promotion.year }}</Link>
                                            <div
                                    ...
                                    <tr class="text-gray-900
                                            ...
                                            <div class="flex gap-x-6">
                                                ...
                                                <div class="flex-auto">
                                                    <div class="flex items-start gap-x-3">
                                                        <Link :href="route('promotion.show', {year: promotion.year, rank: promotion.job_id}, )"
                                        ...
                                        <td class="hidden py-5 pr-6 sm:table-cell">
                                            <Link :href="route('promotion.show', { year: promotion.year, month: 'april', rank: promotion.job_id})" class="text-sm leading-6 text-gray-900 dark:text-gray-50">{{
                                                promotion.april }}
                                            </Link>

                                        </td>
                                        <td class="hidden py-5 pr-6 sm:table-cell">
                                            <Link :href="route('promotion.show', { year: promotion.year, month: 'october', rank: promotion.job_id})" class="text-sm leading-6 text-gray-900 dark:text-gray-50">{{
                                                promotion.october }}
                                            </Link>
                                            ...
                                            <div class="flex justify-end">
                                                <Link :href="route('promotion.show', { year: promotion.year, rank: promotion.job_id})"
                                                    class="text-sm font-medium leading-6 text-green-600 hover:text-green-500 dark:text-gray-50 dark:hover:text-gray-200">View<span
                                                        class="hidden sm:inline"> Details</span></Link>
                                            </div>
                                        </td>
                                    </tr>
                                </template>
