	...
	<MainLayout>
		<div class="py-2">
			...
			<div class="max-w-7xl mx-auto md:px-6 lg:px-8">
				<div
					class="bg-white dark:bg-gray-600 overflow-hidden shadow-sm md:rounded-lg"
				>
					<div
						class="px-4 md:px-0 bg-white dark:bg-gray-600 border-b border-gray-200 dark:border-gray-800 md:flex justify-around md:justify-start"
					>
						<div class="flex flex-col md:flex-row items-center justify-center">
							...
							<div class="pt-8 w-full md:p-8">
								<h1
									class="text-2xl md:text-3xl lg:text-4xl font-bold tracking-wider text-gray-700 dark:text-gray-200"
								>
									{{ person.name }}
								</h1>
								...
								<p
									class="text-lg md:text-xl text-gray-500 dark:gray-text-100 py-4"
								>
									{{ staff.current_job }}
								</p>
								<div class="lg:flex space-y-8 lg:space-y-0 justify-between">
									...
									<div>
										<p
											class="text-lg md:text-xl dark:text-gray-100"
