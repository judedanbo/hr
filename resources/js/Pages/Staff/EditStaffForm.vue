  ...
  <main class="bg-gray-100 dark:bg-gray-700 px-8 py-8">
    ...
    >
      ...
      <FormKit
        ...
        tab-style="progress"
      >
        <FormKit v-if="staff" type="step" name="personalInformation">
          <div class="md:flex md:gap-2 md:flex-wrap w-full">
            ...
            <div class="flex-grow">
              <FormKit
                ...
                name="other_names"
                id="other_names"
                :value="staff.person.other_names"
                label="other Names"
