									...
									<div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
										...
										<div class="mt-2">
											<p class="text-sm text-gray-500">
												...
												<span class="font-bold">{{ dependent.name }} </span>as a
												dependent of
												<span class="font-bold">{{ dependent.staff }}?</span>

												All data of this dependent will be removed.
											</p>
										</div>
									</div>
								</div>
...
let deleteDependent = () => {
	Inertia.delete(route("dependent.delete", { dependent: props.dependent.id }));
	emit("closeModal");
};
</script>
