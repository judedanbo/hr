                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="flex flex-col mt-6">
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="border-b border-gray-200 rounded-md shadow-md"
                                    >
                                        <div
                                            v-if="staff"
                                            class="min-w-full flex flex-wrap py-4"
                                        >
                                            <div
                                                v-for="stf in staff"
                                                :key="stf.id"
                                            ...
                                            >
                                                ...
                                                >
                                                    <div
                                                        class="text-center p-6 bg-gray-600 border-b"
                                                    >
                                                        <div
                                                        ...
                                                        <p
                                                            class="pt-2 text-lg font-semibold text-gray-50"
                                                        >
                                                            {{ stf.name }}
                                                        </p>
                                                        <p
