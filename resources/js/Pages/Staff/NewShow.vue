        ...
        <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          ...
          >
            <div class="flex items-center gap-x-6">
              <div
                class="flex justify-center items-center h-16 w-16 flex-none rounded-full ring-1 ring-green-400/60 dark:ring-gray-300 text-3xl text-green-400/50 dark:text-gray-300 font-bold tracking-wide"
              >
                {{ person.initials }}
              </div>
              <h1>
