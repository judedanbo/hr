        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto md:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm md:rounded-lg">
                    <div
                        class="px-32 md:px-0 bg-white border-b border-gray-200 md:flex justify-around md:justify-start"
                    >
                        <div
                ...
                <div
                    class="flex mt-8 flex-wrap justify-center md:justify-between space-y-8 md:space-y-0"
                >
