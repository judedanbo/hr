			...
			<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
				...
				>
					<InfoCard
						...
						"
					/>
					<InfoCard title="Department" :value="institution.departments" />
					<InfoCard title="Divisions" :value="institution.divisions" />
							...
							<div class="flex items-center justify-start text-lg">
								...
								<div class="flex flex-col">
									...
									<div class="flex justify-start space-x-4">
										...
										<span class="text-sm"> Units: {{ department.units }} </span>
									</div>
								</div>
							</div>
						</li>
