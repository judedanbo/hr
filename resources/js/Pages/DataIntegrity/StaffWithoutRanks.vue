...
<template>
	<MainLayout>
		<Head title="Staff without Ranks" />
				...
				<div class="py-6">
					...
					>
						...
						<p class="mt-2 text-sm text-green-700 dark:text-green-300">
							All active staff members have rank assignments.
						</p>
					</div>
					...
					>
						<p class="text-sm text-blue-700 dark:text-blue-300">
							...
							manually assigned ranks through the staff management
