                                ...
                                <div class="flex gap-4 flex-wrap justify-center">
                                    <div class="bg-white py-2 px-4 md:px-8 xl:px-10 w-full pt-4">
                                        <div class="sm:flex items-center justify-between justify-items-start">
                                            ...
                                            <div class="flex">
                                                <a :href="route(
                                                        'report.recruitment.export-data'
                                                    )
                                                    "
                                                ...
                                                <SelectMenu v-model="selectedRanks" :options="jobs"
                                                    placeholder="Select Rank" multiple />
                                            </div>
                                        </div>
                                            ...
                                            <table class="w-full whitespace-nowrap">
                                                <thead>
                                                    <tr class="bg-gray-100">
                                                        <th class="tracking-wider text-gray-500 text-sm py-2">
                                                            Name
                                                        </th>
                                                ...
                                                <tbody>
                                                    <StaffTableRow :staff="staff" v-for="staff in staff.data"
                                                        :id="staff.id" />
                                                </tbody>
                                            </table>
