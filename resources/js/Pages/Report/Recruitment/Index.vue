                                ...
                                <div class="flex gap-4 flex-wrap justify-center">
                                    ...
                                    <div class="sm:px-6 w-full">
                                        ...
                                        <div class="flex gap-4">
                                            <div class="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10 w-full lg:w-1/2">
                                                ...
                                                <div class="mt-7 overflow-x-auto">
                                                    <table class="w-full whitespace-nowrap">
                                                        ...
                                                        <tbody>
                                                            <tr v-for="data in recruitment" :key="data.year" tabindex="0"
                                                ...
                                                <div class="flex space-x-3 justify-center mt-4">
                                                    ...
                                                    <a :href="route(
                                                                'report.recruitment.export-summary'
                                                            )
                                                            "
                                                        class="cursor-pointer px-4 py-1 rounded-full border-2 border-green-500 hover:text-white hover:bg-green-800 hover:border-white">
                                                        Download Data
                                            ...
                                            <div class="bg-white w-1/2 rounded px-4 py-8">
                                                <RecruitmentChart :recruitment="recruitment" title="Last Ten Recruitment" />
                                                <div class="flex space-x-3 justify-center mt-4">
                                                    <Link :href="route(
