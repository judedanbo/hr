  ...
  <MainLayout>
    <div class="overflow-hidden shadow-sm sm:rounded-lg">
      <div class="px-6 border-b border-gray-200">
        ...
        <ul role="list" class="divide-y divide-gray-100n dark:divide-gray-400 px-8 bg-white dark:bg-gray-500 w-3/4 mx-auto">
          <li
          ...
          >
            <div class="flex min-w-0 gap-x-4">
              ...
              <div class="min-w-0 flex-auto">
                ...
                <p class="mt-1 flex text-xs leading-5 text-gray-500 dark:text-gray-300">
                  <a
            ...
            <div class="flex shrink-0 items-center gap-x-6">
              <div class="hidden sm:flex sm:flex-col sm:items-end">
                <p class="text-sm leading-6 text-gray-900 dark:text-gray-50">{{ staff.rank }}</p>
                <p
                ...
                <div v-else class="mt-1 flex items-center gap-x-1.5">
                  ...
                  <p class="text-xs leading-5 text-gray-500 dark:text-gray-300">Online</p>
                </div>
              </div>
