		...
		<div class="sm:flex sm:items-center">
			<div class="sm:flex-auto">
				...
				<p class="mt-2 text-sm text-gray-700 dark:text-gray-300">
					A list of all offices in Region.
				</p>
			</div>
					...
					<table class="min-w-full divide-y divide-gray-300">
						<thead>
							<tr>
								...
								<th
									scope="col"
									class="px-3 py-3.5 text-xl font-semibold text-gray-900 text-right dark:text-gray-50"
								>
									Units
								</th>
								<!-- <th
                        ...
                        <img class="h-11 w-11 rounded-full" :src="office.image" alt="" />
                      </div> -->
										<div class="pl-8">
											<div
