...
<template>
    ...
    >
        ...
        >
            <MainMenu
                :active="
                    route().current('institution.show', { institution: 21 })
                "
                name="Dashboard"
        ...
        >
            <div class="flex justify-between items-center w-full">
                <div class="flex justify-center items-center space-x-2">
                    ...
                    <div
                        class="hidden lg:flex justify-start flex-col items-start"
                    >
                ...
                <Cog8ToothIcon
                    class="hidden lg:flex cursor-pointer w-6 text-white"
                />
            </div>
        </div>
    </div>
