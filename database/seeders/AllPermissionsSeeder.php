...
class AllPermissionsSeeder extends Seeder
{
     ...
     *
     * This seeder consolidates ALL permissions used in the application.
     * It uses firstOrCreate() for idempotency - safe to run multiple times.
     */
    ...
    /**
     * Get the count of all permissions defined in this seeder.
     */
    public static function getPermissionCount(): int
    {
        return 132;
    }
}
