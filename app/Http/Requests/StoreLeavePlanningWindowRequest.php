...
class StoreLeavePlanningWindowRequest extends FormRequest
{
    ...
    {
        return [
            'leave_year_id' => ['required', 'integer', 'exists:leave_years,id', 'unique:leave_planning_windows,leave_year_id'],
