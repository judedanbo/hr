...
class SeparatedVoluntaryExport implements FromQuery, ShouldAutoSize, ShouldQueue, WithHeadings, WithMapping, WithStyles, WithTitle
{
    use Exportable;

    public function title(): string
    {
        return 'Separated (Voluntary)';
    }
    ...
    public function query()
    {
        return InstitutionPerson::query()
            ...
            ->whereHas('statuses', function ($query) {
                $query->where('status', EmployeeStatusEnum::Voluntary);
            })
            ->retired();
    }
}
